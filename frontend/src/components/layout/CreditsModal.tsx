...
export const CreditsModal: React.FC<CreditsModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-slate-900 rounded-lg max-w-4xl max-h-[90vh] overflow-y-auto"
      ...
      >
        <div className="sticky top-0 bg-slate-900 border-b border-slate-700 p-6 flex justify-between items-center z-10">
          ...
          <button
            onClick={onClose}
            className="text-slate-400 hover:text-white text-3xl font-bold leading-none cursor-pointer"
            aria-label="Close"
          >
            ×
          </button>
        ...
        <div className="p-6 space-y-8">
          ...
          {/* Data Compilation - GitHub */}
          <section className="bg-slate-800 rounded-lg p-6">
            <h2 className="text-2xl font-bold mb-4 text-cyan-400">Data Compilation & Analysis</h2>

            <div className="mb-6">
              <h3 className="text-xl font-semibold mb-2">
                Source:{' '}
                <a
                  href="https://github.com/gshick/Run_Tom_Run"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-cyan-400 hover:text-cyan-300 underline"
                >
                  GitHub: gshick/Run_Tom_Run
                </a>
              </h3>

              <ul className="list-disc list-inside text-slate-300 space-y-1 ml-4">
                <li>CSV compilation of Rotten Tomatoes running distance data</li>
                <li>16 films with distance and box office data</li>
                <li>R-based statistical analysis</li>
              </ul>
            </div>

            <p className="text-sm text-slate-400">
              <strong>Author:</strong> gshick • <strong>License:</strong> GPL-3.0
            </p>
          </section>
          ...
          <section className="bg-slate-800 rounded-lg p-6">
            ...
            <p className="text-sm text-slate-400">
              <strong>Author:</strong> Mark Hobin
            </p>
          </section>
          ...
          <section className="bg-slate-800 rounded-lg p-6">
            ...
            <div className="mb-4">
              <h3 className="text-xl font-semibold mb-2">
                Source:{' '}
                <a
                  href="https://www.youtube.com/watch?v=U8Q2MgdMskQ"
                  target="_blank"
                  rel="noopener noreferrer"
          ...
          {/* Our Analysis */}
          <section className="bg-slate-800 rounded-lg p-6 border-2 border-blue-500">
